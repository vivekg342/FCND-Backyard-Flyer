#!/Users/vivek/miniconda3/envs/fcnd/bin/python
import argparse
import time
...
# print(self.local_position)
    ...
    def state_callback(self):
        ...
        if self.flight_state == States.MANUAL:
            return self.arming_transition()
        elif self.flight_state == States.ARMING:
            return self.takeoff_transition()
    ...
    def calculate_box(self):
        ...
        self.all_waypoints = [
            [EDGE_LENGTH, 0, ALTITUDE],
            [EDGE_LENGTH, EDGE_LENGTH, ALTITUDE],
            [0, EDGE_LENGTH, ALTITUDE],
            [0, 0, ALTITUDE]
        ]
